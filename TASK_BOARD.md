...
## 已发布技能（14 个！🎉🎉🎉🎉🎉🎉🎉）
| 技能名称 | 版本 | 发布时间 | 下载量 | 星数 | 状态 |
|---------|------|---------|--------|------|------|
| batch-renamer | 1.0.0 | 2026-03-06 | 150 | 1 | 🎉 已发布 |
| photo-organizer | 1.0.0 | 2026-03-06 | 168 | 0 | 🎉 已发布 |
| download-organizer | 1.0.0 | 2026-03-06 | 152 | 0 | 🎉 已发布 |
| video-organizer | 1.0.0 | 2026-03-06 | 94 | 0 | 🎉 已发布 |
| music-tagger | 1.0.0 | 2026-03-06 | 92 | 0 | 🎉 已发布 |
| file-sorter | 1.0.0 | 2026-03-07 | 105 | 0 | 🎉 已发布 |
| wechat-formatter | 1.0.0 | 2026-03-14 | 15 | 0 | 🎉 已发布 |
| social-publisher | 1.0.0 | 2026-03-14 | 14 | 0 | 🎉 已发布 |
| xiaohongshu-image-gen | 1.0.0 | 2026-03-14 | 21 | 0 | 🎉 已发布 |
| xiaohongshu-proxy-manager | 1.0.0 | 2026-03-14 | 19 | 0 | 🎉 已发布 |
| image-optimizer-tool | 1.0.0 | 2026-03-15 | 0 | 0 | 🎉 已发布 |
| data-chart-tool | 1.0.0 | 2026-03-15 | - | - | 🎉 已发布 |
| auto-subtitle | 1.0.0 | 2026-03-15 | 0 | 0 | 🎉 已发布 |
audio-note-taker | 1.0.1 | 2026-03-15 | 0 | 0 | 🎉 已发布 |
content-researcher | 1.0.0 | 2026-03-15 | 0 | 0 | 🎉 已发布 |
omegal...
...
5. **content-researcher** - 内容研究者
   - 功能：批量收集和总结文章、视频、新闻，自动生成素材库
   - 技术：summarize（总结）+ 关键词搜索
   - 场景：社交媒体博主素材收集、自媒体行业动态
   - 优先级：中（配合 social-publisher）

6. **content-repurposer** - 内容再利用工具
   - 功能：把一篇文章拆分成多个平台的内容，自动适配格式
   - 技术：基于 social-publisher 的格式化功能
   - 场景：内容创作者一稿多发，节省时间
   - 优先级：中（配合已有的 social-publisher）

7. **meeting-minutes** - 会议纪要生成器
   - 功能：自动生成会议纪要，识别行动项、决策、待办
   - 技术：openai-whisper（语音转文字）+ 文本整理
   - 场景：职场会议整理、远程会议纪要
   - 优先级：中（通用职场需求）
